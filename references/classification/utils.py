...
def init_distributed_mode(args):
    if "RANK" in os.environ and "WORLD_SIZE" in os.environ:
        ...
        print(f"set distributed args from env (rank: {args.rank} {int(os.environ["RANK"])} world_size: {args.world_size} {int(os.environ["WORLD_SIZE"])})")
    ...
    print(f"| distributed init (rank {args.rank}) (world_size {args.world_size}): {args.dist_url}", flush=True)
    torch.distributed.init_process_group(
        backend=args.dist_backend, init_method=args.dist_url, world_size=args.world_size, rank=args.rank
    )

    print("Training start barriering...")
